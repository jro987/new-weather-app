...
const Weather = props => (
    <div className="col s12 m8 l9 weather-output center-wrapper white-text">
        ...
        <div className="row">
            { props.dayTwoDescription && props.dayTwoMaxTemp && props.dayTwoMinTemp && <div className="col s12 m4"><div className="card-panel light-blue center-align day-info"><p className="day-title">{ displayDay[1] },&nbsp;{ props.dayTwoDate.slice(5) }</p><p>{ props.dayTwoDescription }</p><p>Max Temp: { props.dayTwoMaxTemp }</p><p>Min Temp: { props.dayTwoMinTemp }</p></div></div> }
            { props.dayThreeDescription && props.dayThreeMaxTemp && props.dayThreeMinTemp && <div className="col s12 m4"><div className="card-panel light-blue darken-3 center-align day-info"><p className="day-title">{ displayDay[2] },&nbsp;{ props.dayThreeDate.slice(5) }</p><p>{ props.dayThreeDescription }</p><p>Max Temp: { props.dayThreeMaxTemp }</p><p>Min Temp: { props.dayThreeMinTemp }</p></div></div> }
            { props.dayFourDescription && props.dayFourMaxTemp && props.dayFourMinTemp && <div className="col s12 m4"><div className="card-panel light-blue center-align day-info"><p className="day-title">{ displayDay[3] },&nbsp;{ props.dayFourDate.slice(5) }</p><p>{ props.dayFourDescription }</p><p>Max Temp: { props.dayFourMaxTemp }</p><p>Min Temp: { props.dayFourMinTemp }</p></div></div> }
            { props.dayFiveDescription && props.dayFiveMaxTemp && props.dayFiveMinTemp && <div className="col s12 m4"><div className="card-panel light-blue darken-3 center-align day-info"><p className="day-title">{ displayDay[4] },&nbsp;{ props.dayFiveDate.slice(5) }</p><p>{ props.dayFiveDescription }</p><p>Max Temp: { props.dayFiveMaxTemp }</p><p>Min Temp: { props.dayFiveMinTemp }</p></div></div> }
            { props.daySixDescription && props.daySixMaxTemp && props.daySixMinTemp && <div className="col s12 m4"><div className="card-panel light-blue center-align day-info"><p className="day-title">{ displayDay[5] },&nbsp;{ props.daySixDate.slice(5) }</p><p>{ props.daySixDescription }</p><p>Max Temp: { props.daySixMaxTemp }</p><p>Min Temp: { props.daySixMinTemp }</p></div></div> }
            { props.daySevenDescription && props.daySevenMaxTemp && props.daySevenMinTemp && <div className="col s12 m4"><div className="card-panel light-blue darken-3 center-align day-info"><p className="day-title">{ displayDay[6] },&nbsp;{ props.daySevenDate.slice(5) }</p><p>{ props.daySevenDescription }</p><p>Max Temp: { props.daySevenMaxTemp }</p><p>Min Temp: { props.daySevenMinTemp }</p></div></div> }
        </div>
    </div>
);
